                    ...
                    <div class="signup-form">
                        <h2 class="form-title">Sign up</h2>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="<?php echo e(old('name')); ?>" id="name" placeholder="Your Name"/>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            <div class="form-group">
                                ...
                                <input type="email" name="email"   value="<?php echo e(old('email')); ?>" id="email" placeholder="Your Email"/>
                            </div><?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="signup-image">
                        <figure><img src="<?php echo e(asset('auth/images/signup-image.jpg')); ?>" alt="sing up image"></figure>
...
</html><?php /**PATH C:\Users\HD\Desktop\PharmacyTool\resources\views/auth/register.blade.php ENDPATH**/ ?>