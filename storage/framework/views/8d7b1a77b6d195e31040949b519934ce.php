        ...
        <?php if($data && count($data) > 0): ?>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $item->Date)->format('m/d/Y')); ?></td>
                    <td><?php echo e($item->Script); ?></td>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
                ...
                <tr>
                    ...
                    <td>
                      <?php echo e(\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $i->Date)->format('m/d/Y')); ?>
...
<?php /**PATH C:\Users\HD\Desktop\PharmacyTool\resources\views/drugResult.blade.php ENDPATH**/ ?>