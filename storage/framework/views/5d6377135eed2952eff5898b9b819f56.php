...
<?php $__env->startSection('head', 'Add Drug'); ?>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form" method="POST" action="<?php echo e(route('dashboard.drugs.store')); ?>" class="text-start">
                 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.crud', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HD\Desktop\PharmacyTool\resources\views/dashboard/adddrug.blade.php ENDPATH**/ ?>