...
<a href="<?php echo e(route('dash')); ?>" class="btn btn-secondary w-10">Dashboard</a>
...
<body>
    ...
    <form id="searchForm" method="post" action="<?php echo e(route('search')); ?>" class="d-flex flex-column align-items-center">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-3 w-100">
            ...
            <select id="drugName" name="drug_name" class="form-select select2">
                ...
                <?php $__currentLoopData = $drugNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drugName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($drugName); ?>"><?php echo e($drugName); ?></option>
...
</html><?php /**PATH C:\Users\HD\Desktop\PharmacyTool\resources\views/search.blade.php ENDPATH**/ ?>