        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              <a href="<?php echo e(route('dashboard.scripts.create')); ?>" class="text-secondary font-weight-bold text-xs" >
                <h6>ADD SCRIPT</h6>
                </a>
              <form method="GET" action="<?php echo e(route('dashboard.scripts.index')); ?>" class="mb-3">
                <?php echo csrf_field(); ?>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm"><?php echo e($script->Drug_Name); ?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0"><?php echo e($script->Script); ?></p>
                      </td>
                      <td>
                        <span class="text-xs font-weight-bold"><?php echo e($script->Class); ?></span>
                      </td>
                      <td>
                        <span class="text-xs font-weight-bold"><?php echo e($script->insurance_name); ?>        </span>
                      </td>
                      <td class="align-middle text-center">
                        <div class="d-flex align-items-center justify-content-center">
                          <span class="me-2 text-xs font-weight-bold"><?php echo e($script->formatted_date); ?></span>
                          <div>
                            
                            <td class="align-middle">
                              <a href="<?php echo e(route('dashboard.scripts.edit',$script->id)); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                <p style="color: blue"> Edit</p>
                                
                              </a>
                              <form action="<?php echo e(route('dashboard.scripts.destroy', $script->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this drug?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HD\Desktop\PharmacyTool\resources\views/dashboard/scriptsTable.blade.php ENDPATH**/ ?>